...
/** @extends Table<IdentityRow> */
class IdentityTable extends Table
{
    /** @param non-empty-string $tablename */
    public function __construct(Database $database, string $tablename = "identity")
    {
        parent::__construct($database, new TableDefinition($tablename, IdentityRow::class));
    }
}
