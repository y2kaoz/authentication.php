...
/** @extends Table<Srp6aAuthNIdentityRow> */
class Srp6aAuthNIdentityTable extends Table
{
    /** @param non-empty-string $tablename */
    public function __construct(
        Database $database,
        private IdentityTable $identityTable,
        string $tablename = "Srp6aAuthNIdentity"
    ) {
        ...
        parent::__construct($database, new TableDefinition($tablename, Srp6aAuthNIdentityRow::class, $overrides));
    }
}
