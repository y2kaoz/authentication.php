...
/** @extends Table<Srp6aAuthNSessionRow> */
class Srp6aAuthNSessionTable extends Table
{
    /** @param non-empty-string $tablename */
    public function __construct(
        Database $database,
        private IdentityTable $identityTable,
        string $tablename = "Srp6aAuthNSession"
    ) {
        ...
        parent::__construct($database, new TableDefinition($tablename, Srp6aAuthNSessionRow::class, $overrides));
    }
}
